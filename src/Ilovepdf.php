...
use GlennTenorio\LaravelIlovepdf\Exceptions\DownloadException;
use GlennTenorio\LaravelIlovepdf\Exceptions\ProcessException;
use GlennTenorio\LaravelIlovepdf\Exceptions\TaskException;
use GlennTenorio\LaravelIlovepdf\Exceptions\UploadException;
use GlennTenorio\LaravelIlovepdf\Exceptions\StartException;
use GlennTenorio\LaravelIlovepdf\Exceptions\AuthException;
use GlennTenorio\LaravelIlovepdf\IlovepdfTool;
use GlennTenorio\LaravelIlovepdf\Request\Body;
...
//        }
    ...
    {
        $classname = '\\GlennTenorio\\LaravelIlovepdf\\' . ucwords(strtolower($tool)) . 'Task';
